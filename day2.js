...
const performOpcodeCalculation = function(opcode, param1, param2, param3, intcode) {
  switch(opcode) {
    case 1:
...
const runIntcode = function(intcodeFilepath, noun, verb) {
  ...
  let param1 = intcode[1];
  let param2 = intcode[2];
  let param3 = intcode[3];
  let i = 0
  while (opcode != endProgramOpcode) {
    intcode = performOpcodeCalculation(opcode, param1, param2, param3, intcode);
    i = i + 4;
    opcode = intcode[i];
    param1 = intcode[i+1];
    param2 = intcode[i+2];
